          ...
          <Row>
            ...
            <Col lg="2">
              <div className="hero_img-box hero_video-box mt-4">
                <video src={heroVideo} autoPlay loop muted controls />
              </div>
            </Col>
            <Col lg="2">
          ...
          <Row>
            <Col lg="6">
              <div className="experience_content">
                ...
                <p>
                Discover the Jewel of the Indian Ocean with Our Unforgettable world Adventures!,
                  <br />
